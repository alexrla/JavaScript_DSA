/*
  ...
  Pseudocódigo:
  - Se o "índice" for menor que zero ou maior que comprimento
  da lista, retorne false;
  - Se o "índice" for igual ao comprimento da lista, coloque o
  novo nó no final da lista;
  - Se o "índice" for 0, desloque o novo nó para o início da 
  lista;
  - Caso contrário, utilizando o método get, acesse o nó de index - 1;
  - Defina a propriedade next desse nó, para ser o novo nó;
  - Defina a propriedade next desse novo nó para ser a propriedade
  next do nó acessado em index - 1;
  - Incremente o comprimento da lista em 1;
  - Retorne true;
*/
